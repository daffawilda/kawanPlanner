<x-layoutAdmin>
    <x-slot name="title">Tambah Soal</x-slot>

    <div class="container mx-auto mt-4 px-4 py-6">
        <h2 class="text-2xl font-bold mb-4">Tambah Soal</h2>
        ...
        <form action="{{ route('soals.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="pertanyaan" name="pertanyaan" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required></textarea>
            </div>
